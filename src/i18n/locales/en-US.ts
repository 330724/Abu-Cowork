...
const enUS: TranslationDict = {
  ...
  imChannel: {
    ...
    capabilityChatOnly: 'Chat Only',
    capabilityReadTools: 'Read Tools',
    capabilitySafeTools: 'Safe Tools',
    capabilityFull: 'Full Access',
    allowedUsers: 'Allowed Users',
    allowedUsersPlaceholder: 'Enter user ID, press Enter to add',
    allowedUsersHint: 'Leave empty to allow everyone (full level auto-downgrades to safe_tools)',
