...
| 服务商 | API 格式 | 内置联网搜索 | 内置图片生成 | 说明 |
|--------|----------|:---:|:---:|------|
| **Anthropic** | Anthropic 原生 | ✅ | — | Claude 系列模型，推荐使用 |
| **火山引擎** | OpenAI 兼容 | ✅ | — | 字节跳动云服务，豆包模型 |
| **阿里百炼** | OpenAI 兼容 | ✅ | ✅ | 阿里云大模型平台，通义千问等 |
| **智谱 AI** | OpenAI 兼容 | ✅ | ✅ | 清华技术团队，GLM 系列 |
| **Moonshot** | OpenAI 兼容 | ✅ | — | Kimi 背后的模型 |
| **OpenAI** | OpenAI 兼容 | — | ✅ | GPT 系列模型 |
| **硅基流动** | OpenAI 兼容 | — | ✅ | 多模型聚合平台 |
| **DeepSeek** | OpenAI 兼容 | — | — | 性价比高，支持推理模型 |
| **七牛云** | OpenAI 兼容 | — | — | 多模型聚合，15+ 模型 |
| **OpenRouter** | OpenAI 兼容 | — | — | 海外模型聚合路由 |
| **本地模型** | OpenAI 兼容 | — | — | Ollama、LM Studio 等 |
| **自定义 API** | 可选 | — | — | 任意 OpenAI/Anthropic 兼容接口 |

> **✅** 表示服务商内置支持该能力，选择后可直接使用，无需额外配置。
